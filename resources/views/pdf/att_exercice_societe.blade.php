...
<body class="ThePdf">
    ...
    <div class="mx-8 " >
        ...
        <div class="mt-3">
            ...
            <p>
            <span class="font-medium text-xl">E</span>st  bien   connue   de  nos  services  comme  exerçant  la  profession  sus-indiquée et ce en  vertu  de  son  inscription  au   Registre  de  Commerce  de  {{$res->lieu_rc}}   sous   le  n° {{$res->rc}} depuis le  {{$res->date_rc}}. 
            </p>
