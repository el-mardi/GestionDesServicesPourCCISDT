...
<body class="ThePdf">
    ...
    <div class="mx-8 " >
        <div class="mt-0 mb-8">
         ...
         <div class="mt-5">
             ...
             <p class="text-center mt-5 text-2xl">
                 <b>Atteste que, la coopérative :</b>
             </p>
             <table class="my-5">
                <tbody>
                    <tr>
        ...
        <div class="mt-3">
            ...
            <p>
            <span class="font-medium text-xl">E</span>st  bien   connue   de  nos  services  comme  exerçant  l'activité  sus-indiquée et ce en  vertu  de  son  inscription  au   Registre local des coopératives  de  {{$res->lieu_rc}}   sous   le  n° {{$res->rc}} depuis le  {{$res->date_rc}}. 
            </p>

            <p class="mt-2">
            <span class="font-medium text-xl">C</span>ette Attestation est délivrée à l’intéressée sur sa demande pour servir et valoir ce que de droit.
            </p>
