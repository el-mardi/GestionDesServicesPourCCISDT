...
<form action="{{route('enregis_orientation')}}" method="POST" class="flex-col flex">
    @csrf
    ...
    <table class="border-separate border border-slate-400 w-8/12 mx-auto mt-5">
        <thead>
          <tr>
            <th class="border border-slate-300 ">L'action</th>
    ...
    <label for="date_debut" class="text-gray-700 mt-5 mb-0">Date:</label>
    ...
    <div id='createBtn' class="mx-auto" style="display: none"> 
        <button id="submit" type="submit" class='mx-auto p-2 m-5 bg-green-300 rounded-md shadow-lg w-fit hover:cursor-pointer hover:bg-green-400'>Enregistrer & Imprimer la fiche</button>  
